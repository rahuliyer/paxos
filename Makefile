...
all: main.cpp PaxosBrain.o PaxosState.o
	$(CXX) $(INCLUDES) $(FLAGS) $(DEFINES) $(LIBRARY_INCLUDES) -o main main.cpp PaxosServiceHandler.cpp thrift/gen-cpp/PaxosService.cpp thrift/gen-cpp/Paxos_types.cpp thrift/gen-cpp/Paxos_constants.cpp PaxosBrain.o PaxosState.o $(SERVER_LIBS)
